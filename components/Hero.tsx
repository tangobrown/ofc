  ...
  return (
    <section id="content" data-hero className={`relative w-full overflow-hidden ${heightCls}`}>
      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-center px-6 pb-[60px] pt-[150px] text-center">
        <h1 className="m-0 max-w-[700px] font-display text-[clamp(34px,4.9vw,66px)] font-semibold uppercase leading-[1.14] tracking-[0.03em] text-heading-light [text-shadow:0_2px_18px_rgba(0,0,0,.6)]">
          {title}
        </h1>
        {subtitle && (
          <p
            className={`mt-[18px] text-[clamp(14px,1.3vw,18px)] text-[#e2dccf] ${
